...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 px-6 bg-bw-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-8 bg-bw-white rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-bw-gray"
            >
              <div className="w-16 h-16 bg-bw-black rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <feature.icon className="w-8 h-8 text-bw-white" />
              </div>
              <h3 className="text-2xl font-bold text-bw-black mb-3">
                {feature.title}
              </h3>
        ...
        <div className="mt-20 bg-bw-black rounded-3xl p-12 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-bw-white mb-6">
            Our Mission
          </h3>
          <p className="text-xl text-bw-gray max-w-3xl mx-auto leading-relaxed">
